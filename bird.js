const Birds = (() => {
        ...
        <svg viewBox="0 0 80 44" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <linearGradient id="birdBody" x1="0" x2="1">
                    <stop offset="0" stop-color="rgba(40,45,50,.78)"/>
                    <stop offset="1" stop-color="rgba(15,20,25,.82)"/>
                </linearGradient>
                <linearGradient id="birdWing" x1="0" x2="1">
                    <stop offset="0" stop-color="rgba(255,255,255,.88)"/>
                    <stop offset="1" stop-color="rgba(70,80,90,.72)"/>
                </linearGradient>
            </defs>
            ...
            <path d="M48 22 L59 19 L50 26 Z" fill="rgba(30,35,40,.78)"/>
            <circle cx="53" cy="20.5" r="1" fill="rgba(0,0,0,.55)"/>
        </svg>`;
    }
    ...
    function createBird(){
        ...
        b.style.setProperty("--curve", rand(-45,45) + "px");
        b.style.animationDuration = rand(12,20) + "s";
    ...
    function start(){
        for(let i=0;i<5;i++){
            setTimeout(createBird, i*1600);
        }
        setInterval(createBird, 5200);
    }
